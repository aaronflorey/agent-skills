...
Source: https://bootstrap-vue-next.github.io/bootstrap-vue-next/docs/configurations/global-options.html

##### On this page

-   [Overview ​](#overview)
    
-   [Limitations with modelValues ​](#limitations-with-modelvalues)
    

# Global Options [​](#global-options)

Set default prop values for all Vue components.

[Edit this page on GitHub](https://github.com/bootstrap-vue-next/bootstrap-vue-next/edit/main/apps/docs/src/docs/configurations/global-options.md)
