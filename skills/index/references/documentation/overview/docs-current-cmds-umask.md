Source: https://fishshell.com/docs/current/cmds/umask.html

# umask - set or get the file creation mode mask[¶](#umask-set-or-get-the-file-creation-mode-mask "Link to this heading")
