Source: https://fishshell.com/docs/current/cmds/case.html

# case - conditionally execute a block of commands[¶](#case-conditionally-execute-a-block-of-commands "Link to this heading")
