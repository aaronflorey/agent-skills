Source: https://fishshell.com/docs/current/cmds/string-split.html

# string-split - split strings by delimiter[¶](#string-split-split-strings-by-delimiter "Link to this heading")
