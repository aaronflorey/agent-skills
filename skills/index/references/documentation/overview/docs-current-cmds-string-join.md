Source: https://fishshell.com/docs/current/cmds/string-join.html

# string-join - join strings with delimiter[¶](#string-join-join-strings-with-delimiter "Link to this heading")
