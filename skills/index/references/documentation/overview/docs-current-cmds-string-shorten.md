Source: https://fishshell.com/docs/current/cmds/string-shorten.html

# string-shorten - shorten strings to a width, with an ellipsis[¶](#string-shorten-shorten-strings-to-a-width-with-an-ellipsis "Link to this heading")
