Source: https://fishshell.com/docs/current/cmds/ulimit.html

# ulimit - set or get resource usage limits[¶](#ulimit-set-or-get-resource-usage-limits "Link to this heading")
