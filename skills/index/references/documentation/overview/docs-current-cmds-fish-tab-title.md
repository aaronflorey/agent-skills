Source: https://fishshell.com/docs/current/cmds/fish_tab_title.html

# fish\_tab\_title - define the terminal tab’s title[¶](#fish-tab-title-define-the-terminal-tab-s-title "Link to this heading")
