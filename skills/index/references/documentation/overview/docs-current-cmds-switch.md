Source: https://fishshell.com/docs/current/cmds/switch.html

# switch - conditionally execute a block of commands[¶](#switch-conditionally-execute-a-block-of-commands "Link to this heading")
...
Note that [break](break.html) cannot be used to exit a case/switch block early like in other languages. It can only be used in loops.
