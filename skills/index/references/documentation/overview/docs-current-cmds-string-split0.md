Source: https://fishshell.com/docs/current/cmds/string-split0.html

# string-split0 - split on zero bytes[¶](#string-split0-split-on-zero-bytes "Link to this heading")
