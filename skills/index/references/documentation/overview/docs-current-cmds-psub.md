Source: https://fishshell.com/docs/current/cmds/psub.html

# psub - perform process substitution[¶](#psub-perform-process-substitution "Link to this heading")
