Source: https://fishshell.com/docs/current/cmds/count.html

# count - count the number of elements of a list[¶](#count-count-the-number-of-elements-of-a-list "Link to this heading")
