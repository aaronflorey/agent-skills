---
description: gives instructions on setting up the current repository with repo-type-aware OSS, GitHub Actions, releases, and docs
tools:
  read: true
  bash: true
  grep: true
...
Inspect the current repository and set it up for OSS publishing, GitHub Actions, release automation, badges, and docs using the smallest correct set of changes for the detected stack.
</objective>
